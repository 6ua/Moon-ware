...
finity.theme = { -- Normal Mode
main_container = Color3.fromRGB(10,10,10),
separator_color = Color3.fromRGB(10,10,10),
...
scrollbar_color = Color3.fromRGB(15,15,15),
}
...
function finity.new(isdark, gprojectName, thinProject)
	...
	self2.ChangeToggleKey = function(NewKey)
		...
		if not projectName then
			self2.tip.Text = "Moon-ware | " .. game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name .. ""
		end
